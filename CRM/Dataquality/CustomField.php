 ...
 * @license AGPL-3.0
 */
class CRM_Dataquality_CustomField {

  protected $_apiParams = array();

  /**
   * CRM_Dataquality_CustomField constructor.
   */
  ...
  private function validateCreateParams($params) {
    if (!isset($params['name']) || empty($params['name']) || !isset($params['custom_group_id'])
      ...
      mandatory parameters and can not be empty in class CRM_Dataquality_CustomField');
    }
