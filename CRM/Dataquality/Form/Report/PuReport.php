 ...
 *
 */
class CRM_Dataquality_Form_Report_PuReport extends CRM_Report_Form {
    ...
    $this->_columns = array(
      ...
      array(
        ...
        array(
          'sort_name' =>
          array(
            'title' => ts('Last Name, First Name'), 'default' => '1', 'default_weight' => '1', 'default_order' => 'ASC',
          ),
          'gender_id' =>
          array(
            'name' => 'gender_id',
...
//    print "custom!".print_r($this->_columns["civicrm_value_pu_fields_1"],true);
  
       $this->_columns[$this->_puFieldSet]['order_bys'][$this->_puField] =
          array(
            'name' => 'pu_overview_1',
            'title' => ts('Pu'),
            'default'=> 1,
  ...
  function getPuFields()
  {
     ...
     foreach ($this->_columns as $colname => $col){
        if (isset($col["group_title"]) && $col["group_title"] == "Pu fields"){ 
